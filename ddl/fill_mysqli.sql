...
-- AGREGAR USUARIOS
	...
	CALL AgregarUsuario('admin', 1, 'Admin', 'Admin', 'HH', 'HH', '1122334456', '112234@abc.com', 'AAAAAA', 'Cuarto', 'Sistemas Computacionales', 0, 'admin');
	CALL AgregarUsuario('user', 1, 'Docente', 'user', 'HH', 'HH', '1122334456', '112234@abc.com', 'AAAAAA', 'Cuarto', 'Sistemas Computacionales', 0, 'user');
